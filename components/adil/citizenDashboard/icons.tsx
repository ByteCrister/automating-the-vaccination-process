...
export const NIDIcon: React.FC<IconProps> = ({ className = "w-5 h-5" }) => (
  <svg className={className} fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
export const QRIcon: React.FC<IconProps> = ({ className = "w-5 h-5" }) => (
  <svg className={className} fill="none" stroke="currentColor" viewBox="0 0 24 24">
    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 4v1m6 11h2m-6 0h-2v4m0-11v3m0 0h.01M12 12h4.01M12 15h4.01M12 21h4.01M12 4h4.01M12 7h4.01M12 10h4.01M12 14h4.01M9 11H5a2 2 0 00-2 2v6a2 2 0 002 2h6a2 2 0 002-2v-6a2 2 0 00-2-2z" />
  </svg>
);

export const BellIcon: React.FC<IconProps> = ({ className = "w-5 h-5" }) => (
  <svg className={className} fill="none" stroke="currentColor" viewBox="0 0 24 24">
    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15 17h5l-5 5v-5zM15 7v1a3 3 0 01-3 3H9a3 3 0 01-3-3V7m6 0V4a2 2 0 00-2-2H8a2 2 0 00-2 2v3m6 0H9m0 0V4m0 3h6" />
  </svg>
);
...
export const ChevronIcon: React.FC<IconProps & { direction?: 'up' | 'down' | 'left' | 'right' }> = ({
  ...
  return (
    <svg className={`${className} ${rotations[direction]}`} fill="none" stroke="currentColor" viewBox="0 0 24 24">
